        ...
        <section className="py-20 px-6">
          <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center">
            ...
            <div className="md:w-1/2">
              <img src="https://img.freepik.com/free-photo/futuristic-business-scene-with-ultra-modern-ambiance_23-2151003763.jpg?t=st=1732514739~exp=1732518339~hmac=d29110d2dd9596a21616dea2f93a42664abbdb2a971d7cb03d469c1a10c4bf7e&w=900" alt="" />
            </div>
          </div>
        </section>
        ...
        <section className="py-20 px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                { title: 'AI-Driven Persona Mapping', description: 'Track and analyze your cultural metrics with intelligent data visualization', image: '1stt.jpg' },
                ...
                <Card key={index}>
                  <CardContent className="p-6">
                    <Image src={`/${card.image}`} alt={card.title} width={300} height={200} className="rounded-lg mb-4" />
